...
fn verify_bill_payment() {
    ...
    consuming_payable_dao.more_money_payable(&serving_node_1_wallet, amount).unwrap();
    consuming_payable_dao.more_money_payable(&serving_node_2_wallet, amount).unwrap();
    consuming_payable_dao.more_money_payable(&serving_node_3_wallet, amount).unwrap();
    ...
    serving_node_1_receivable_dao.more_money_receivable(&contract_owner_wallet, amount).unwrap();
    ...
    serving_node_2_receivable_dao.more_money_receivable(&contract_owner_wallet, amount).unwrap();
    ...
    serving_node_3_receivable_dao.more_money_receivable(&contract_owner_wallet, amount).unwrap();
